...
<div class="jumbotron" id="jumbotron">
  ...
  <button type="button" class="btn btn-danger" data-toggle="collapse" href="#my-alert-box"><h6><b>SELL</b></h6>
   <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
</button>
<div id="my-alert-box" class="alert alert-warning collapse" role="alert">
   <button type="button" class="close" data-toggle="collapse" href="#my-alert-box">
   <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
   </button>
   <p>MAKE AN ACCOUNT TO SELL YOUR CAR.</p>
</div>
<button type="button" class="btn btn-danger" data-toggle="collapse" href="#my-alert-box2"><h6><b>BUY</b></h6>
   <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
</button>
<div id="my-alert-box2" class="alert alert-warning collapse" role="alert">
   <button type="button" class="close" data-toggle="collapse" href="#my-alert-box2">
   <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
   </button>
   <p>MAKE AN ACCOUNT TO BUY YOUR CAR.</p>
</div>
<button type="button" class="btn btn-danger" data-toggle="collapse" href="#my-alert-box3"><h6><b>RENT</b></h6>
   <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
</button>
<div id="my-alert-box3" class="alert alert-warning collapse" role="alert">
   <button type="button" class="close" data-toggle="collapse" href="#my-alert-box3">
   <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
   </button>
   <p>MAKE AN ACCOUNT TO RENT YOUR CAR.</p>
</div>
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <div class="service-box mt-5">
              <h3 class="mb-3"><a href="#"><b>SELL</b></a></h3>
