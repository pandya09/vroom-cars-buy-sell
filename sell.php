...
function validate() {
        if(document.getElementById('year').value !== '' || document.getElementById('make').value !== '' )
    {
       return true;
    }
...
.select::after {
  ...
  transition: .25s all ease;
	...
	<body>
		...
		<form method="post" name="sell_car" action="done.php" enctype="multipart/form-data" onsubmit="return validate()">
			<br>
			<div class="form-control">
				<table>
					...
					<tr><td style="padding-right: 100px; padding-left: 50px;">
						...
						<td>
							<input type="submit" id="sell_now" name="sell_now" value="SELL NOW" class="btn btn-block btn-primary" >
						</td>
					</tr>
				</table>
			</div>
